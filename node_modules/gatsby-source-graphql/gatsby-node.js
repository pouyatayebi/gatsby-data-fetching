...
} = require(`./batching/dataloader-link`);
...
exports.createSchemaCustomization = async ({
  ...
  const defaultTransforms = [new StripNonQueryTransform(), new RenameTypes(name => `${typeName}_${name}`), new NamespaceUnderFieldTransform({
    typeName,
    fieldName,
    resolver
  })];
  const schema = transformSchema ? transformSchema({

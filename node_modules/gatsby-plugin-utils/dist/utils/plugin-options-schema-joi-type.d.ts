declare type Types = "any" | "alternatives" | "array" | "boolean" | "binary" | "date" | "function" | "link" | "number" | "object" | "string" | "symbol";
declare type BasicType = boolean | number | string | any[] | object | null;
declare type LanguageMessages = Record<string, string>;
declare type PresenceMode = "optional" | "required" | "forbidden";
...
declare type GuidVersions = "uuidv1" | "uuidv2" | "uuidv3" | "uuidv4" | "uuidv5";
...
declare type ValidationErrorFunction = (errors: ErrorReport[]) => string | ValidationErrorItem | Error;
...
declare type CustomValidator<V = any> = (value: V, helpers: CustomHelpers) => V;
declare type ExternalValidationFunction = (value: any) => any;
declare type SchemaLikeWithoutArray = string | number | boolean | null | Schema | SchemaMap;
declare type SchemaLike = SchemaLikeWithoutArray | object;
declare type SchemaMap<TSchema = any> = {
    [key in keyof TSchema]?: SchemaLike | SchemaLike[];
};
export declare type Schema = AnySchema | ArraySchema | AlternativesSchema | BinarySchema | BooleanSchema | DateSchema | FunctionSchema | NumberSchema | ObjectSchema | StringSchema | LinkSchema | SymbolSchema;
declare type SchemaFunction = (schema: Schema) => Schema;
...
declare type ComparatorFunction = (a: any, b: any) => boolean;
...
declare type ExtensionBoundSchema = Schema & SchemaInternals;
interface RuleArgs {
    name: string;
    ref?: boolean;
...
declare type RuleMethod = (...args: any[]) => any;
...
declare type CoerceFunction = (value: any, helpers: CustomHelpers) => CoerceResult;
...
declare type ExtensionFactory = (joi: PluginOptionsSchemaJoi) => Extension;
interface Err {
    toString(): string;
}

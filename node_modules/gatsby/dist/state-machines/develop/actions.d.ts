...
export declare const markSourceFilesDirty: import("xstate").AssignAction<IBuildContext, AnyEventObject>;
export declare const markSourceFilesClean: import("xstate").AssignAction<IBuildContext, import("xstate").EventObject>;
export declare const setRecompiledFiles: import("xstate").AssignAction<IBuildContext, AnyEventObject>;
